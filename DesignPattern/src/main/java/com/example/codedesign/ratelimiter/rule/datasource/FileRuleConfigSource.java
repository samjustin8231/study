...
import com.example.codedesign.ratelimiter.rule.parser.JsonRuleConfigParser;
import com.example.codedesign.ratelimiter.rule.parser.RuleConfigParser;
import com.example.codedesign.ratelimiter.rule.parser.YamlRuleConfigParser;
...
public class FileRuleConfigSource implements RuleConfigSource {
    ...
    public RuleConfig load() {
        ...
        for (String extension : SUPPORT_EXTENSIONS) {
            log.info("=====> load config, file extension:{}", extension);
            InputStream in = null;
            try {
